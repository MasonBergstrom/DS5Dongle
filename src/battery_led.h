...
// Reads PowerPercent / PowerState from USBGetStateData
// (DualSense BT 0x31 report, see utils.h).
//
...
// reconnect retries while interrupt_in_data still reports low battery.
